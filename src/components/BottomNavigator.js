  ...
  return (
    <nav id="bottom-navigator" className="bottom-navigator">
      <ul className="bottom-navigator__navbar">
        <li
          className={`bottom-navigator__item${
            storeCtx.activePage === "chart" ? " active" : ""
          }`}
          onClick={() => storeCtx.activePageHandler("chart")}
        >
          <svg
        ...
        <li
          className={`bottom-navigator__item${
            storeCtx.activePage === "market" ? " active" : ""
          }`}
          onClick={() => storeCtx.activePageHandler("market")}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
        ...
        <li
          className={`bottom-navigator__item${
            storeCtx.activePage === "trade" ? " active" : ""
          }`}
          onClick={() => storeCtx.activePageHandler("trade")}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
        ...
        {/* {storeCtx.isLogin && (
          <li
            className={`bottom-navigator__item${
              storeCtx.activePage === "assets" ? " active" : ""
            }`}
            onClick={() => storeCtx.activePageHandler("assets")}
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="none" fill-rule="evenodd"><path d="M0 0h24v24H0z"></path><path fill="#4B4B52" fill-rule="nonzero" d="M21.1 15.851h-2.099c-1.886 0-3.279-1.26-3.279-3.1s1.393-3.196 3.279-3.196h2.1V7.2a.663.663 0 0 1-.192.028H6.285a.64.64 0 0 1-.648-.632c0-.349.29-.632.648-.632H20.93a2.692 2.692 0 0 0-2.521-1.7H3.878c-1.487 0-2.692 1.175-2.692 2.625v10.17c0 1.451 1.205 2.627 2.692 2.627h14.53c1.487 0 2.692-1.176 2.692-2.626v-1.21zm1.186 0v1.21c0 2.148-1.768 3.89-3.949 3.89H3.95C1.768 20.951 0 19.21 0 17.061V6.89C0 4.74 1.768 3 3.949 3h14.388c2.181 0 3.949 1.742 3.949 3.89v2.665h1.031c.377 0 .683.298.683.666v4.964a.675.675 0 0 1-.683.666h-1.031zm.509-5.102h-3.813c-1.212 0-2.055.821-2.055 2.003 0 1.182.843 1.905 2.055 1.905h3.813v-3.908zm-3.64 2.732a.739.739 0 0 1-.747-.73c0-.402.335-.729.748-.729s.748.327.748.73c0 .403-.335.73-.748.73z"></path></g></svg>
